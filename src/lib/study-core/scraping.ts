...
// Détection de blocage : extraite dans le module feuille blockDetection.ts
// (consommée aussi par le registre des adaptateurs — cycle d'import sinon).
// Ré-exportée ici pour que tous les importeurs existants restent intacts.
export { BLOCKED_KEYWORDS, detectBlockedContent } from './blockDetection';
